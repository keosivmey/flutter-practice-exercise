...
import 'data/repositories/settings/app_setting_repository_mock.dart';
...
List<SingleChildWidget> get devProviders {
  return [
    ...
    ChangeNotifierProvider<AppSettingsState>(
      create: (_) => AppSettingsState(mockRepository, repository: mockRepository),
    ),
  ];
}

AppSettingsRepository mockRepository = AppSettingsRepositoryMock();
