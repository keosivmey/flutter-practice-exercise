...
import 'package:bla_bla_car/week8_BLA_MVVM/ui/screens/home/widgets/home_history_tile.dart';
import 'package:bla_bla_car/week8_BLA_MVVM/utils/animations_util.dart';
import 'package:bla_bla_car/week8_BLA_MVVM/ui/screens/rides_selection/rides_selection_screen.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import '../../../theme/theme.dart';
import 'package:bla_bla_car/week8_BLA_MVVM/ui/widgets/pickers/bla_ride_preference_picker.dart';
...
class HomeContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final mv = context.watch<HomeViewModel>();

    return Stack(children: [_buildBackground(), _buildForeground(context, mv)]);
  }

  Widget _buildForeground(BuildContext context, HomeViewModel mv) {
    return Column(
      children: [
        SizedBox(height: 16),
        Align(
  ...
  Widget _buildHistory(BuildContext context, HomeViewModel mv) {
